        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-700 w-full max-w-lg rounded-2xl p-6 shadow-2xl animate-in fade-in zoom-in-95">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs uppercase font-bold text-slate-500 mb-1 block">Task Title</label>
                <input 
                  value={editTitle}
              ...
              <div>
                <label className="text-xs uppercase font-bold text-slate-500 mb-1 block">Instructions</label>
                <textarea 
                  value={editDesc}
                  onChange={(e) => setEditDesc(e.target.value)}
                  className="w-full h-32 bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-white outline-none focus:border-blue-500 resize-none text-sm leading-relaxed"
                />
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-bold shadow-lg"
              >
